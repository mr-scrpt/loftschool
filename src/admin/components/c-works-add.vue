        ...
        .tile__content-add
          ...
          .editor__row
            ...
            span.input.input--size-l.editor__input-full.input_active
              span.input__box
                input(placeholder="Название группы" value="Git" v-model="work.title").input__control
          ...
          .editor__row
            ...
            span.input.input--size-l.editor__input-full.input_active
              span.input__box
                input(placeholder="Название группы" value="Git" v-model="work.link").input__control
          //Одно поле с лэйблом КОНЕЦ
